...
> для запуска виртуальной машины _AutoInstalled Server_ __после завершения разворачивания офисной сети__ из [Vagrantfile](Vagrantfile), будет использоваться _Virsh_ - консольная утилита, предназначенная для управления виртуальными машинами 
> и гипервизорами _KVM_ и _Xen_.
...
virt-install \
        ...
        --graphics spice \
```
В этом примере для разворачивания хоста заданы следующие параметры:
